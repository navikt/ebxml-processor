...
class CpaRepoClient(clientProvider:()->HttpClient) {
    ...
    //middlertidi, vil fikse det
    suspend fun getPublicSigningDetails(messageHeader: MessageHeader): SignatureDetails =
    ...
    suspend fun getPublicSigningDetails(cpaId: String, partyType: String, partyId: String, service: String, action: String, role: String): SignatureDetails {
        ...
        */
        ...
        return postSignatureDetailsRequest("$cpaRepoEndpoint/signing/certificate", request)
    }
}
