...
sub has_decode_arith_coding;
sub has_encode_arith_coding;
sub i_readjpeg_wiol;
...
sub Rmpcr_div_2ui;
sub Rmpcr_get_exp;
sub Rmpcr_get_exp_mpfr;
sub Rmpcr_inf_p;
sub Rmpcr_init;
sub Rmpcr_init_nobless;
sub Rmpcr_lt_half_p;
sub Rmpcr_max;
sub Rmpcr_mul;
sub Rmpcr_mul_2ui;
sub Rmpcr_out_str;
sub Rmpcr_out_str_win;
sub Rmpcr_print;
sub Rmpcr_print_win;
sub Rmpcr_say;
sub Rmpcr_say_win;
...
sub Rmpcr_set_inf;
sub Rmpcr_set_one;
sub Rmpcr_set_str_2str;
sub Rmpcr_set_ui64_2si64;
sub Rmpcr_set_zero;
sub Rmpcr_split;
sub Rmpcr_sqr;
sub Rmpcr_sqrt;
...
sub _has_pv_nv_bug;
sub _is_NOK_and_POK;
sub _mpc_header_version;
sub _mpc_header_version_str;
}
...
sub Rmpcr_sub_rnd;
sub Rmpcr_zero_p;
sub _get_radius_exponent;
sub _get_radius_mantissa;
}
package Math::MPFR {
sub B0() ;
sub B110() ;
...
sub Rmpfr_init_set;
sub Rmpfr_init_set_IV;
sub Rmpfr_init_set_IV_nobless;
sub Rmpfr_init_set_NV;
sub Rmpfr_init_set_NV_nobless;
sub Rmpfr_init_set_d;
sub Rmpfr_init_set_d_nobless;
sub Rmpfr_init_set_f;
sub Rmpfr_init_set_f_nobless;
sub Rmpfr_init_set_float128;
sub Rmpfr_init_set_float128_nobless;
...
sub overload_dec;
sub overload_div;
sub overload_div_2exp;
sub overload_div_2exp_eq;
sub overload_div_eq;
sub overload_equiv;
sub overload_exp;
sub overload_gt;
...
sub overload_lte;
sub overload_mul;
sub overload_mul_2exp;
sub overload_mul_2exp_eq;
sub overload_mul_eq;
sub overload_not;
...
package Test::File::Win32 {
sub GetOSVersion;
sub GetProcessPrivileges;
sub IsDeveloperModeEnabled;
}
