...
values ('Behandler',        'HarBorgerFrikort',         'EgenandelForesporsel', false, false, false, TRUE,  TRUE,  TRUE,  'LoggEgenandel', 'Avvisning'),
       ...
       ('Fastlegeregister', 'PasientlisteForesporsel',  'AbonnementStatus',     false, false, false, TRUE,  false, false, null,            null       ),
       ('Fastlegeregister', 'PasientlisteForesporsel',  'Avvisning',            false, false, false, TRUE,  false, false, null,            null       ),
       ('Fastlegeregister', 'PasientlisteForesporsel',  'Kvittering',           false, false, false, TRUE,  false, false, null,            null       ),
