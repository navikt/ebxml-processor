...
open class CpaValidationException(
    message: String, errorCode: ErrorCode = ErrorCode.DELIVERY_FAILURE, severity: String = SeverityType.ERROR.value(), exception: java.lang.Exception? = null): EbmsException(message,errorCode,severity,exception)
