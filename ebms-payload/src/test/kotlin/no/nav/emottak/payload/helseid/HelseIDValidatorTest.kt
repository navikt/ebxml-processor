...
internal class HelseIDValidatorTest {
    ...
    fun validateHelseIDFromRealLifeM1() {
        ...
        validator.getValidatedNin(b64, timeStamp = timeStamp, certificates = certsFromM1)
    }
    ...
    fun validateHelseID2() {
        ...
        TimeUnit.MILLISECONDS.sleep(20)
        val timeStamp = ZonedDateTime.now()
        validator.getValidatedNin(token, timeStamp, certificates = setOf(certificate))
    }
...
internal fun timestampAndErrorPairs(): List<Arguments> {
    return listOf(
        Arguments.of(
            ...
            "Timestamp (Mon Dec 10 13:51:00 CET 2018) is before token not-before time (Tue Dec 11 12:52:29 CET 2018)"
        ),
        Arguments.of(
            "2018-12-12T13:51:00.000+01:00",
            "Timestamp (Wed Dec 12 13:51:00 CET 2018) is after token expiry time (Tue Dec 11 13:52:29 CET 2018)"
        )
    )
}
