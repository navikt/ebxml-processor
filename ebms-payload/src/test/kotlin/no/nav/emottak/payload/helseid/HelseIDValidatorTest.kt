...
internal class HelseIDValidatorTest {
    ...
    fun `validate helseID with EC jwk`() {
        ...
        validateHomeMadeHelseId(
            ...
            scope = HelseIDValidator.SUPPORTED_SCOPES.first(),
            audience = HelseIDValidator.SUPPORTED_AUDIENCE.first(),
            errMsg = "no certificate to verify token with given",
...
internal fun timestampAndErrorPairs(): List<Arguments> {
    return listOf(
        Arguments.of("2018-12-10T13:51:00.000+01:00", "Timestamp (Mon Dec 10 13:51:00 CET 2018) is before token not-before time (Tue Dec 11 12:52:29 CET 2018)"),
