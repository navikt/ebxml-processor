    ...
    routing {
        ...
        get("/test_async_payload/{referenceId}") {
            ...
            try {
                ...
                val asyncPayload = smtpTransportClient.getPayload(referenceIdParameter!!)
                log.debug("Async payload test: Payload retrieved: {}", asyncPayload)
                log.debug("Async payload test: contentId retrieved: {}", asyncPayload.contentId)
            } catch (e: Exception) {
